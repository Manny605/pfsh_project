...
if(isset($_GET['categorie_id'])) {
    ...
    if($articles_categorie) {
        ...
        $recentArticle = getMostRecentArticleInCategoryAr($categorie_id);
?>
<!doctype html>
<html lang="ar">
<head>
    <title>المقالات <?php echo $categorie_nom ?></title>
    <meta charset="utf-8" />
        ...
        <div class="container-fluid mt-5">
            <div class="row">
                ...
                <div class="container">
                    <div class="row justify-content-md-center">
                        <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                            <h2 class="mb-4 display-5 text-center text-danger">المقالات <?php echo $categorie_nom; ?> الحديثة</h2>
                ...
                <div class="container mt-5">
                    <div class="row justify-content-md-center">
                        <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
                            <h2 class="mb-4 display-5 text-center text-danger">آخر مقال</h2>
                            <p class="text-secondary mb-5 text-center lead fs-4">ابقَ مُستمعًا ومُطّلعًا على آخر التحديثات</p>
                            <hr class="w-50 mx-auto mb-5 mb-xl-9 border-dark-subtle">
                        </div>
                    </div>
                </div>
