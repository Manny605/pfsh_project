                        ...
                        <?php foreach ($AllArticles as $article) : ?> <!-- corrected variable name from $articles to $article -->
                            ...
                            <article>
                                ...
                                <ul class="entry-meta list-unstyled d-flex mb-2">
                                    <li>
                                    <a class="link-primary text-decoration-none" href="articles_par_categorie.php?categorie_id=<?php echo $article['categorie_id']; ?>"><?php echo $article['nom_categorie']; ?></a>
                                    </li>
                                </ul>
                                <h2 class="entry-title h4 mb-0">
                                    <a class="link-dark text-decoration-none" href='article_id.php?id=<?php echo $article['id']; ?>'><?php echo $article['titre']; ?></a> <!-- corrected variable name from $firstArticle to $article -->
                                </h2>
                                </div>
                                <div class="entry-footer">
                                <ul class="entry-meta list-unstyled d-flex align-items-center mb-0">
                                    <li>
                                    <div class="fs-7 link-secondary text-decoration-none d-flex align-items-center" href="#!">
                                    ...
                                    <li>
                                    <div class="link-secondary text-decoration-none d-flex align-items-center" href="#!">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                                        <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm0 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm0 1c-2.667 0-8 1.334-8 4v1c0 .619 1.262 1 4 1h8c2.738 0 4-.381 4-1v-1c0-2.666-5.333-4-8-4z" />
                                        </svg>
